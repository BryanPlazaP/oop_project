...
public class ProductService {
    ...
    public List<ProductDTO> getProduct() {
        ...
        for(Product pro : productIterable) {
            ...
            product.setSupplier(Arrays.asList(pro.getSupplier().getName()));
            product.setProduct_name(pro.getName());
